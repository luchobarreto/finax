package com.finax.utils;

import com.finax.dto.FileDTO;
...
public class DataBucketUtil {
    ...
    @Value("${finax.app.gcpConfigFile}")
    private String gcpConfigFile;
    
    @Value("${finax.app.gcpProjectId}")
    private String gcpProjectId;
    
    @Value("${finax.app.gcpBucketId}")
    private String gcpBucketId;
    
    @Value("${finax.app.gcpDirectoryName}")
